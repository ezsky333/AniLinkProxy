...
func loadConfig() (AppConfig, error) {
	...
	cfg := AppConfig{
		...
		CaptchaProvider:            strings.TrimSpace(strings.ToLower(getenv("CAPTCHA_PROVIDER", "auto"))),
		AliyunCaptchaPrefix:        strings.TrimSpace(os.Getenv("ALIYUN_CAPTCHA_PREFIX")),
		AliyunCaptchaRegion:        strings.TrimSpace(strings.ToLower(getenv("ALIYUN_CAPTCHA_REGION", "cn"))),
		AliyunCaptchaSceneID:       strings.TrimSpace(os.Getenv("ALIYUN_CAPTCHA_SCENE_ID")),
		AliyunCaptchaAccessKeyID:   strings.TrimSpace(os.Getenv("ALIYUN_CAPTCHA_ACCESS_KEY_ID")),
		AliyunCaptchaAccessKeySecret: os.Getenv("ALIYUN_CAPTCHA_ACCESS_KEY_SECRET"),
		AliyunCaptchaEndpoint:      strings.TrimSpace(os.Getenv("ALIYUN_CAPTCHA_ENDPOINT")),
		CaptchaLaAppKey:            strings.TrimSpace(os.Getenv("CAPTCHALA_APP_KEY")),
		CaptchaLaAppSecret:         os.Getenv("CAPTCHALA_APP_SECRET"),
